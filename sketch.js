...
var gameState = PLAY;
var gameOveri, restarti,gameOver, restart;
function preload(){
...
function setup() {
  ...
  invisibleGround = createSprite(width/2,height-30,400,10);
...
function reset(){
  ...
  trex.changeAnimation("t1", trex_running);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,height-34,10,40);
